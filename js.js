...
button.addEventListener('click', function() {
	alert('Родился 5 ноября 1987 года в г.Дрезден, Германия. В 2009 году окончил \n Томский Политехнический Университет, факультет "Автоматики и вычислительной техники" по специальности "Автоматизация систем управления"')
})
